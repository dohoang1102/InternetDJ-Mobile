...
+ (void)registerForNetworkReachabilityNotifications
{
	[[xReachability reachabilityForInternetConnection] startNotifier];
...
{
	return ([[xReachability reachabilityForInternetConnection] currentReachabilityStatus] == ReachableViaWWAN);	
}
